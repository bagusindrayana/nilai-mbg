...
<div
  class="min-h-screen bg-white dark:bg-black text-black dark:text-white transition-colors duration-200"
>
  <div class="container mx-auto px-3 py-4 max-w-5xl">
    <!-- Header -->
    <header
      class="flex justify-between items-start mb-6 border-b border-gray-300 dark:border-gray-700 pb-3"
    >
      <div>
        <h1 class="text-lg font-bold tracking-tight">ANGGARAN & PROGRAM MBG</h1>
        <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">
          Monitor alokasi anggaran Program Makan Bergizi Gratis Nasional
        </p>
